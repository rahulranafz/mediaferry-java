...
public class MailCount {
    ...
    public int FetchMails(String host, String username, String password, String sub) {
    ...
    public static void main(String args[]) {
        ...
        int count = mailCount.FetchMails("imap.gmail.com", "qa.gaurav239@gmail.com", "result1029", "[FromName] EKCS has a query Testing Fi 401401");
